...
class Vector3D 
{
    ...
    public void SetVector(Vector3D w) {for (int i = 0; i < 3; i++) vector[i] = w.GetVector()[i];}
    public void SetVector(float[] vector_) {for (int i = 0; i < 3; i++) vector[i] = vector_[i];}
    public void SetVector(float w1, float w2, float w3) {vector[0] = w1; vector[1] = w2; vector[2] = w3;}
    public void Add(Vector3D w) {for (int i = 0; i < 3; i++) vector[i] += w.GetVector()[i];}
