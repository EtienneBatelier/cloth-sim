...
class Masse:public Dessinable
{
	...
	double m;		// a priori identique pour toutes les masses : static ?
	double lambda;  // a priori identique pour toutes les masses : static ?
	...
	//Constructeurs
	Masse(double const&, double const&, Vecteur3D const&, Vecteur3D const&, std::vector<Ressort*> res={},SupportADessin* support=nullptr);//ICI
