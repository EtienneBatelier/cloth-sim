...
{
public:
  GLWidget(std::vector<Tissu*> tissus, std::vector<Contrainte*> contraintes_, Integrateur* const& I_, QWidget* parent = nullptr)
    : QGLWidget(parent), c(tissus, contraintes_, &vue), I(I_){
